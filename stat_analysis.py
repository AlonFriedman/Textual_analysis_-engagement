...
if __name__ == "__main__":
    ...
    print("\nAdverbs Comparison:")
    print("  First Project:", comparison_result['adverbs']['first_project'])
    print("  Final Project:", comparison_result['adverbs']['final_project'])

    print("\nNouns Comparison:")
    print("  First Project:", comparison_result['nouns']['first_project'])
    print("  Final Project:", comparison_result['nouns']['final_project'])

    print("\nSentiment Comparison:")
    print("  First Project:", comparison_result['sentiment']['first_project'])
    print("  Final Project:", comparison_result['sentiment']['final_project'])
